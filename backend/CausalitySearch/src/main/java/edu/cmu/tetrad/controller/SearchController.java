...
package edu.cmu.tetrad.controller;
...
public class SearchController {
    ...
    @CrossOrigin("*")
    @RequestMapping(value = "/edu/tongji/xlab/causality/search/{algorithm}", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
//@RequestMapping(value = "/edu.tongji.xlab.causality.search/{algorithm}", method = RequestMethod.POST)
