...
//        return new TetradMatrix(new LUDecomposition(apacheData).getSolver().getInverse());
    ...
    public TetradMatrix ginverse() {
        ...
        return new TetradMatrix(edu.tongji.xlab.util.MatrixUtils.pseudoInverse(data));
    }
    ...
    public TetradMatrix transposeWithoutCopy() {
        RealMatrix transpose = edu.tongji.xlab.util.MatrixUtils.transposeWithoutCopy(apacheData);
    ...
    public boolean isSymmetric(double tolerance) {
        return edu.tongji.xlab.util.MatrixUtils.isSymmetric(apacheData.getData(), tolerance);
    }
