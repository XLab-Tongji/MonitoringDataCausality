...
import edu.tongji.xlab.util.Parameters;
...
public class SessionNode implements Node, TetradSerializable {
     ...
     * order) in a simulation edu.tongji.xlab.study.
     *
     * @serial Range > 0.
     */
...
//                continue;
    ...
    private class SessionHandler extends SessionAdapter {
        ...
        /**
         * When a new execution is begun of a simulation edu.tongji.xlab.study, this event is
