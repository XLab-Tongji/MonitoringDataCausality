...
import edu.tongji.xlab.data.*;
import edu.tongji.xlab.graph.*;
...
import edu.tongji.xlab.data.IKnowledge;
import edu.tongji.xlab.data.Knowledge2;
import edu.tongji.xlab.data.KnowledgeEdge;
import edu.tongji.xlab.graph.*;
