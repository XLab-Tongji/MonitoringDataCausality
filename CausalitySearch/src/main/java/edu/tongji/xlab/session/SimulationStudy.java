...
package edu.tongji.xlab.session;

import edu.tongji.xlab.util.TetradLogger;

import java.util.*;
import java.util.prefs.Preferences;

/**
 * Runs a simulation edu.tongji.xlab.study for a session which traverses a subtree of the
...
public final class SimulationStudy {
    ...
    /**
     * The session, nodes of which this simulation edu.tongji.xlab.study is executing.
     */
    ...
    /**
     * Constructs a new simulation edu.tongji.xlab.study for the given session.
     */
...
//        this.nodesToExecute = nodesWithModels();
     ...
     * execution has begun of a simulation edu.tongji.xlab.study.
     */
